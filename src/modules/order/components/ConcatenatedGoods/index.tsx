...
import { concatenatedGoodsType } from '@/modules/truck/truck.enum';
...
import { concatenatedGoodsPayload } from '@/modules/truck/truck.enum';
...
const ConcatenatedGoods = (props: ComponentProps) => {
  /*
   * Props of Component
   */
  const {
  ...
  const {
    ...
    ORDER_SERVICETYPE_CONCATENATED_GOODS_REFNUMBER,
      ...
      <Form.Row className="service-type-wrapper">
        ...
        <Col xs="6" lg="4" className="border-middle">
          <Form.Group controlId="referenceNo" className="referenceNo">
            <Form.Label>
              <span>{t(ORDER_SERVICETYPE_CONCATENATED_GOODS_REFNUMBER)}</span>
              <OverlayTrigger
                key={'right'}
                placement={'bottom'}
                overlay={
        ...
        <Container fluid>
          <Row>
            ...
            >
              ...
              <Form.Control
                ...
                onChange={handleChange}
                isInvalid={!!errors.concatenatedGoodsType}
              >
                {concatenatedGoodsType.map((value, index) => {
                  return (
                    <option
                      key={`concatenated-goods-type-${index}`}
                      value={value.key}
                    >
                      {t(value.label)}
                    </option>
          ...
          <Row>
            <Form.Group
              ...
              xs={12}
              lg={7}
              controlId="concatenatedGoodsQuantity"
              className="concatenatedGoodsQuantity"
            >
              <Form.Label className="form-label-required">
              ...
              <Form.Control
                type="text"
                name="concatenatedGoodsQuantity"
                defaultValue={values.concatenatedGoodsQuantity}
                onChange={handleChange}
                isInvalid={!!errors.concatenatedGoodsQuantity}
              />
              <Form.Control.Feedback type="invalid">
                {errors.concatenatedGoodsQuantity}
              </Form.Control.Feedback>
            </Form.Group>
            ...
            <Form.Group
              ...
              xs={12}
              lg={5}
              controlId="concatenatedGoodsPayload"
            ...
            >
              ...
              <Form.Control
                as="select"
                name="concatenatedGoodsPayload"
                defaultValue={values.concatenatedGoodsPayload ?? ''}
                onChange={handleChange}
                isInvalid={!!errors.concatenatedGoodsPayload}
              >
                {concatenatedGoodsPayload.map((value, index) => {
                  return (
              ...
              <Form.Control.Feedback type="invalid">
                {errors.concatenatedGoodsPayload}
              </Form.Control.Feedback>
            </Form.Group>
          </Row>
        </Container>
...
export default observer(ConcatenatedGoods);
