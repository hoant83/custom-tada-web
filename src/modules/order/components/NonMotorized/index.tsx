...
const NonMotorized = (props: ComponentProps) => {
  /*
   * Props of Component
   */
  const {
        ...
        <Container fluid>
          <Row>
            ...
            >
              ...
              <Form.Control
                ...
                onChange={handleChange}
                isInvalid={!!errors.nonMotorizedType}
              >
                {nonMotorizedType.map((value, index) => {
                  return (
                    <option key={`motorized-type-${index}`} value={value.key}>
                      {t(value.label)}
                    </option>
                  );
                })}
          ...
          <Row>
            <Form.Group
              ...
              xs={12}
              lg={7}
              controlId="nonMotorizedQuantity"
              className="nonMotorizedQuantity"
            >
              <Form.Label className="form-label-required">
              ...
              <Form.Control
                type="text"
                name="nonMotorizedQuantity"
                defaultValue={values.nonMotorizedQuantity}
                onChange={handleChange}
                isInvalid={!!errors.nonMotorizedQuantity}
              />
              <Form.Control.Feedback type="invalid">
                {errors.nonMotorizedQuantity}
              </Form.Control.Feedback>
            </Form.Group>
            ...
            >
              ...
              <Form.Control
                as="select"
                name="nonMotorizedPayload"
                defaultValue={values.nonMotorizedPayload ?? ''}
                onChange={handleChange}
                isInvalid={!!errors.nonMotorizedPayload}
              >
                {nonMotorizedPayload.map((value, index) => {
                  return (
...
export default observer(NonMotorized);
