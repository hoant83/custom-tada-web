                ...
                <Form.Group controlId="priceRequest" className="priceRequest">
                  ...
                  {showPrice && (
                    <NumberFormat
                      ...
                      onValueChange={(value) => {
                        setFieldValue &&
                          setFieldValue('priceRequest', value.value, false);
                      }}
                      decimalSeparator="."
                      displayType="input"
                      type="text"
        ...
        <Container fluid>
          <Row>
            ...
            {useOtherPayment && (
              <Form.Group
                ...
                xs={12}
                lg={7}
                controlId="otherPaymentType"
                className="form-group-otherPaymentType fex-item"
              >
                <Form.Control
                  className="bottom"
                  type="text"
                  value={initData.otherPaymentType}
                  onChange={handleChange}
                  placeholder={t(ORDER_OTHER_PAYMENT_NOTES)}
                  isInvalid={!!errors.otherPaymentType}
                ></Form.Control>
                <Form.Control.Feedback type="invalid">
                  {errors.otherPaymentType}
                </Form.Control.Feedback>
              </Form.Group>
            )}
          </Row>
          <Row>
            ...
            >
              ...
              <Form.Control
                ...
                defaultValue={initData.inChargeName ?? ''}
              />
              <Form.Control.Feedback type="invalid">
                {errors.inChargeName}
              </Form.Control.Feedback>
            ...
            >
              ...
              <Form.Control
                ...
                defaultValue={initData.inChargeContactNo ?? ''}
              />
              <Form.Control.Feedback type="invalid">
          ...
          <Row>
            ...
            >
              ...
              <span
                onClick={() => {
                  window.open(`${CUSTOMER_ROUTERS.SETUP}?scroll=my-favourite`);
                }}
