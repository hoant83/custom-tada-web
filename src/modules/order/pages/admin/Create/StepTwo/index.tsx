      ...
      <Form.Row className="route-info">
        <Container fluid>
          ...
          <Row className="pickup-section">
            ...
            >
              <Form.Label>{t(ORDER_PICKUP_TIME)}</Form.Label>
              <Form.Control
                ...
                hidden
              />
              <DateTimePicker value={pickupTime} onChange={onChangeTime} />
              <Form.Control.Feedback type="invalid">
                {errors.pickupTime}
              </Form.Control.Feedback>
            </Form.Group>
          ...
          {values.dropOffFields && values.dropOffFields.length > 0
            ? values.dropOffFields.map(
                (dropOffField: any, index: string | number) => (
                      ...
                      <Container fluid>
                        <Row>
                          ...
                          >
                            ...
                            <GoogleMapAutocompleteDynamic
                              ...
                              value={
                                values.dropOffFields[index].dropoffAddressText
                              }
                              onChange={(event: any) => {
                                handleChangeDynamic(
                                  index,
                        ...
                        <Row>
                          ...
                          >
                            ...
                            <Form.Control
                              value={
                                values.dropOffFields[index]
                                  ? values.dropOffFields[index].dropoffTime
                                  : ''
                              }
                              onChange={onChange}
                            ...
                            />
                            <DateTimePicker
                              value={values.dropOffFields[index].dropoffTime}
                              onChange={(value: any) => {
                          ...
                          >
                            ...
                            <Form.Control
                              type="text"
                              value={values.dropOffFields[index].dropoffContact}
                              onChange={(event: any) => {
                                handleChangeDynamic(
                                  index,
                                  event,
                          ...
                          >
                            ...
                            <Form.Control
                              type="text"
                              value={
                                values.dropOffFields[index].dropoffContactNo
                              }
                              onChange={(event: any) => {
                                handleChangeDynamic(
                                  index,
