...
export const Errors: ErrorDto[] = [
  ...
  {
    key: ERRORS.PICKUP_DROPOFF_NOT_FOUND,
    label: I18N.MESSAGES_PICKUP_DROPOFF_NOT_FOUND,
  },
  {
    key: ERRORS.INCORRECT_IMPORT_DATA,
    label: I18N.MESSAGES_INCORRECT_IMPORT_DATA,
  },
];
