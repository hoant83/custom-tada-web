...
const DeletedCustomerGridAdmin = (props: ComponentProps) => {
  ...
  React.useEffect(() => {
    setItems(customerStore.deletedCustomers);
    setTotalPage(Math.ceil(totals / +pageSizeOptions[1]));
  }, [items, customerStore.deletedCustomers, totals]);
...
export default observer(DeletedCustomerGridAdmin);
